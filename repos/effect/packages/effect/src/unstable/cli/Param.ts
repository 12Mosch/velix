 ...
 * @since 4.0.0
 */
export interface Map<Kind extends ParamKind, in out A, out B>
 ...
 * @since 4.0.0
 */
export interface Transform<Kind extends ParamKind, in out A, out B>
	extends Param<Kind, B> {
 ...
 * @since 4.0.0
 */
export interface Optional<Kind extends ParamKind, A>
	extends Param<Kind, Option.Option<A>> {
 ...
 * @since 4.0.0
 */
export interface Variadic<Kind extends ParamKind, A>
	extends Param<Kind, ReadonlyArray<A>> {
