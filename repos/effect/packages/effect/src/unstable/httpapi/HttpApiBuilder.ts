 ...
 * @since 4.0.0
 */
export interface Handlers<R, Endpoints extends HttpApiEndpoint.Any = never>
	extends Pipeable {
...
function getResponseTransformation(
	...
	return Transformation.transformOrFail({
		decode: (res) =>
			Effect.fail(
				new Issue.Forbidden(Option.some(res), {
...
function getResponseEncode<E>(
	...
	e: E,
) => Effect.Effect<Response.HttpServerResponse, Issue.InvalidValue, never> {
