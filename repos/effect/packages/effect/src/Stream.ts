 ...
 * @since 2.0.0
 */
export interface StreamUnify<A extends { [Unify.typeSymbol]?: any }>
...
export const catchTag: {
	...
	>(
		...
		orElse?:
			...
			| undefined,
	): <A, R>(self: Stream<A, E, R>) => Stream<A1 | A | A2, E1 | E2, R1 | R | R2>;
	<
		A,
		E,
		R,
...
export const orElseIfEmpty: {
	...
	<A, E, R, A2, E2, R2>(
		...
		fromChannel(
			Channel.orElseIfEmpty(self.channel, (_) => toChannel(orElse())),
		),
);
...
export const onError: {
	...
	<A, E, R, X, R2>(
		...
		fromChannel(Channel.onError(self.channel, cleanup)),
);
