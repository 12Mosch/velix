...
export declare namespace IndexedDbQuery {
	 ...
	 * @since 4.0.0
	 */
	export interface Clear<Table extends IndexedDbTable.AnyWithProps>
	 ...
	 * @since 4.0.0
	 */
	export interface Modify<Table extends IndexedDbTable.AnyWithProps>
		extends Effect.Effect<
	 ...
	 * @since 4.0.0
	 */
	export interface ModifyAll<Table extends IndexedDbTable.AnyWithProps>
		extends Effect.Effect<
