...
function createControllerSlice<
	T extends object,
	const K extends readonly (keyof T)[],
>(controller: T, keys: K): Pick<T, K[number]> {
	const slice = {};
	...
	for (const key of keys) {
		...
		if (!descriptor) {
			throw new Error(`Missing planner controller property: ${String(key)}`);
		}

		Object.defineProperty(slice, key, descriptor);
	}
...
export function createPlannerPageContext() {
	...
	const form = createControllerSlice(controller, [
		"plannerMode",
		"startStop",
		"waypointStops",
		"destinationStop",
	...
	const routes = createControllerSlice(controller, [
		"routeRequestError",
		"isRouting",
		"routeAlternatives",
		"selectedRouteIndex",
	...
	const map = createControllerSlice(controller, [
		"mapClickSelection",
	...
	const importExport = createControllerSlice(controller, [
		"routeImportError",
		"isImportingGpx",
		"routeExportError",
		"gpxImportInput",
	...
	const sharing = createControllerSlice(controller, [
		"routeShareErrors",
		"routeShareUrls",
		"isSharingRoute",
		"activeRouteShareCopied",
	...
	const save = createControllerSlice(controller, [
		"saveSyncError",
		"activeSavedRouteId",
		"plannerDraftRouteId",
		"isActiveRouteSaved",
	...
	const analysis = createControllerSlice(controller, [
		"directionsOpen",
		"routeAnalysisOpen",
		"selectedCueIndex",
		"selectedCueFocusKey",
